      ...
      <div className="auth-card horizontal-layout">
        ...
        <div className="auth-content-wrapper">
          ...
          <div className="social-login-container">
            <button className="social-btn google" onClick={() => login()} title="Continue with Google">
            ...
            <button className="social-btn apple" onClick={() => alert("Apple Login coming soon!")} title="Continue with Apple">
            ...
            <button className="social-btn facebook" onClick={() => alert("Facebook Login coming soon!")} title="Continue with Facebook">
